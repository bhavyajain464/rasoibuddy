...
import { resetWebAppHomePath } from '../navigation/webDeepLink';
...
const TOKEN_KEY = 'restaurant_authToken';
const USER_KEY = 'restaurant_authUser';
  ...
  const promptAsync = useCallback(async () => {
    try {
      ...
      if (msg.includes('DEVELOPER_ERROR') || code === '10') {
        showAppError(
          'Google Sign-In is not set up for this build. Add SHA-1 for com.kitchenai.restaurant in Google Cloud Console.',
        );
        return;
      }
